...
class Cipher:
    def __init__(self):
        ...
        self.swap = dict(zip([ord("ą"), ord("ć"), ord("ę"), ord("ó"), ord("ł"), ord("ż"), ord("ź"), ord("ń")],
                           ["a", "c", "e", "o", "l", "z", "z", "n"]))
        self.swap2 = dict(zip([ord("Ą"), ord("Ć"), ord("Ę"), ord("Ó"), ord("Ł"), ord("Ż"), ord("Ź"), ord("Ń")],
                            ["A", "C", "E", "O", "L", "Z", "Z", "N"]))
...
class Ceasar(Cipher):
    def encoding(self, public, key):
        ...
        for letter in public:
            if letter.isalpha():
                if letter.isupper():
                    encrypted += self.alphabet2Upper[(self.alphabetUpper[letter.translate(self.swap2)] + key) % self.mod]
                else:
                    encrypted += self.alphabet2Lower[(self.alphabetLower[letter.translate(self.swap)] + key) % self.mod]
            else:
                encrypted += letter

        with open("crypto.txt", "w") as crypto, open("extra.txt", "w") as extra:
    ...
    def decrypting(self, text, key):
        ...
        for letter in text:
            if letter.isalpha():
                if letter.isupper():
                    decrypted += self.alphabet2Upper[(self.alphabetUpper[letter.translate(self.swap2)] - key) % self.mod]
                else:
    ...
    def cryptoanalysisPublic(self, helper, encrypted):
        ...
        while text != encrypted[0]:
            ...
            if helper[0].isupper():
                text = self.alphabet2Upper[(self.alphabetUpper[helper[0].translate(self.swap2)] + i) % self.mod]
            else:
                text = self.alphabet2Lower[(self.alphabetLower[helper[0].translate(self.swap)] + i) % self.mod]

        with open("key-new.txt", "w") as keynew:
            keynew.write(str(i))
        ...
        with open("decrypt.txt", "w") as decrypt:
            for i in range(26):
                for letter in encrypted:
                    if letter.isalpha():
                        if letter.isupper():
                            text += self.alphabet2Upper[(self.alphabetUpper[letter.translate(self.swap2)] - i) % self.mod]
                        else:
...
class Affine(Cipher):
    def encoding(self, public, a, b):
        ...
        if self.nwd(a, self.mod) != 1 or a * a2 % 26 != 1:
            ...
            for letter in public:
                if letter.isalpha():
                    if letter.isupper():
                        encrypted += self.alphabet2Upper[((self.alphabetUpper[letter.translate(self.swap2)] * a) + b) % self.mod]
                    else:
    ...
    def decrypting(self, text, a, b):
        ...
        for letter in text:
            if letter.isalpha():
                if letter.isupper():
                    decrypted += self.alphabet2Upper[(self.alphabetUpper[letter.translate(self.swap2)] * a2 + b2) % self.mod]
                else:
        ...
        for a in range(1, self.mod + 1):
            if a % 2 != 0 and a != 13:
                for b in range(1, self.mod + 1):
                    if helper[0].isupper():
                        decr1 = self.alphabet2Upper[(self.alphabetUpper[helper[0].translate(self.swap2)] * a + b) % self.mod]
                    else:
                        decr1 = self.alphabet2Lower[(self.alphabetLower[helper[0].translate(self.swap)] * a + b) % self.mod]

                    if helper[1].isupper():
                        decr2 = self.alphabet2Upper[(self.alphabetUpper[helper[1].translate(self.swap2)] * a + b) % self.mod]
                    else:
                ...
                if a % 2 != 0 and a != 13:
                    for b in range(1, self.mod + 1):
                        for letter in text:
                            if letter.isalpha():
                                if letter.isupper():
                                    decrypted += self.alphabet2Upper[(self.alphabetUpper[letter.translate(self.swap2)] * a + b) % self.mod]
                                else:
...
if "-e" in sys.argv and "-c" in sys.argv:
    ...
    ceasar = Ceasar()
    with open("plain.txt", "r") as plain, open("key.txt", "r") as key:
        keys = key.read().split(" ")
        a = int(keys[0])
        if a > 26 or a < 1:
    ...
    aff = Affine()
    with open("key.txt", "r") as key, open("plain.txt", "r") as plain:
        keys = key.read().split(" ")
    ...
    ceasar = Ceasar()
    with open("crypto.txt", "r") as crypto, open("key.txt", "r") as key:
        keys = key.read().split(" ")
        a = int(keys[0])
        if a > 26 or a < 1:
            raise AttributeError("Invalid key!")
    ...
    aff = Affine()
    with open("key.txt", "r") as key, open("crypto.txt", "r") as crypto:
        keys = key.read().split(" ")
        a, b = int(keys[0]), int(keys[1])
        if a > 26 or b > 26 or a < 1 or b < 1:
            raise AttributeError("Invalid key!")
    ...
    ceasar = Ceasar()
    with open("extra.txt", "r") as extra, open("crypto.txt", "r") as crypto:
